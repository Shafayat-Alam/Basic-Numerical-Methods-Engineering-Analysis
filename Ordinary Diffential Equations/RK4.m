% Main script - save as RK4.m
% Case a
alpha_A = 0.25; f_A = 0; beta_A = 0;
[x_A1, M_A1] = solveRK4(alpha_A, f_A, beta_A, 0.7, 'A');
[x_A2, M_A2] = solveRK4(alpha_A, f_A, beta_A, 1.5, 'A');

% Case b
alpha_B = 0; f_B = 0.005; beta_B = 0;
[x_B1, M_B1] = solveRK4(alpha_B, f_B, beta_B, 0.7, 'B');
[x_B2, M_B2] = solveRK4(alpha_B, f_B, beta_B, 1.5, 'B');

% Case c
alpha_C = 0; f_C = 0; beta_C = 50;
[x_C1, M_C1] = solveRK4(alpha_C, f_C, beta_C, 0.5, 'C');
[x_C2, M_C2] = solveRK4(alpha_C, f_C, beta_C, 2.0, 'C');
...
% RK4 implementation
function [x, M] = solveRK4(alpha, f, beta, M_0, caseType)
    x = linspace(0, 5, 21);
    h = x(2) - x(1);
    M = zeros(size(x));
    M(1) = M_0;
